...
$(document).ready(function() {
  ...
  $("#signup-form").submit(function(event){
    ...
    if (playerOneName === "" || playerTwoName === "") {
      alert("Please enter a name for each player to access the game");
      return;
    }
    ...
    if (player1.turn === true) {
      if (player1.scoreTotal >= 100 || player2.scoreTotal >= 100) {
        ...
        if (player1.currentScore === 1) {
          ...
          $(this).text("Roll");
          $("#player-msg").text(playerTwoName + ", BOSS,STAAAART!");
        }
        else {
      ...
      if (player2.scoreTotal >= 100 || player1.scoreTotal >= 100) {
        ...
        if (player2.currentScore === 1) {
          ...
          totalRoll = 0;
          $("#player-msg").text(playerOneName + ", BOSS,STAAAART!");
        }
        else {
  ...
  $("#hold").click(function() {
    if (player1.turn === true) {
      ...
      $("#roll").text("Roll");
      $("#player-msg").text(playerTwoName + ", your turn right now!");
    }
    else {
      player1.takeTurn();
      player2.takeTurn();
      ...
      $("#player-msg").text(playerOneName + ", your turn right now!");
    }
  });
